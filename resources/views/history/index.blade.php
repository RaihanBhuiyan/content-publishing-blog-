                        ...
                        @if ($autoSave->changelog)
                            <div class="changelog-info">
                                <span class="user"><i class="fa-solid fa-user"></i>
                                    {{ $autoSave->changeUser->firstname . ' ' . $autoSave->changeUser->lastname }}</span>
                                <span class="changelog"><i class="fa-solid fa-square-pen"></i> <span
                                        class="text">{{ $autoSave->changelog }}</span></span>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="history_card">
                        ...
                        <div class="body">
                            ...
                            <div class="bottom-info">
                                <span class="created"><i class="fa-regular fa-clock"></i>
                                    {{ $post->updated_at->diffForHumans() }}, <span
                                        class="time">{{ $post->updated_at->format('H:i') }}</span></span>
                            ...
                            @if ($post->changelog)
                                <div class="changelog-info">
                                    <span class="user"><i class="fa-solid fa-user"></i>
                                        {{ $post->changeUser->firstname . ' ' . $post->changeUser->lastname }}</span>
                                    <span class="changelog"><i class="fa-solid fa-square-pen"></i> <span
                                            class="text">{{ $post->changelog }}</span></span>
                                </div>
                            @endif
                        </div>
                    </div>
