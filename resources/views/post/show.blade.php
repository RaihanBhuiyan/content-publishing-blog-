        ...
        <div class="post_container">
            <div class="top">
                ...
                <div class="info">
                    ...
                    @endif
                    <p class="date">{{ $post->created_at->format('d.m.Y') }} by
        ...
        <div class="post_body">
            ...
            <div class="actions">
                @isset($nextPost)
                    ...
                    <a href="{{ route('post.show', $nextPost->slug) }}">Next post <i
                            class="fa-solid fa-arrow-right"></i></a>
                @else
                    <a href="{{ route('home') }}" style="width: 100%"><i class="fa-solid fa-arrow-left"></i> Back to
                        homepage</a>
                @endisset
            </div>
        </div>
    ...
    <script>
        document.querySelectorAll('img:not(.profile_img)').forEach(function(img) {
            ...
            img.addEventListener('click', function() {
                ...
                overlay.style.cssText = 'background: RGBA(0,0,0,.5) url(' + src +
                    ') no-repeat center; background-size: contain; width: 100%; height: 100%; position: fixed; z-index: 10000; top: 0; left: 0; cursor: zoom-out;';
