                ...
                <tbody class="body_user_list">
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td data-label="Background">{{ $category->backgroundColor }}
                                <span class="box" style="background: {{ $category->backgroundColor }};"> </span>
                            </td>
                            <td data-label="Color">{{ $category->textColor }}
                                <span class="box" style="background: {{ $category->textColor }};"> </span>
                            </td>
                            ...
                            <td data-label="Actions">
                                ...
                                @can('category-delete')
                                    ...
                                    <button onClick="confirmDelete({{ $category->id }}, 'category')" class="delete">
