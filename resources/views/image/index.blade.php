    ...
    <div class="images">
        ...
        <div class="image_modal" style="display: none;">
            ...
            <div class="file_info">
                ...
                @can('image-delete')
                    <button class="button" onclick="deleteImage(event);" data-name="na">Delete <i
