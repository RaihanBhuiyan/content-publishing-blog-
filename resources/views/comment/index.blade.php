                ...
                <div class="filtr_body">
                    <div class="view">
                        ...
                        <div class="buttons view">
                            <div class="view_button list active" onclick="changeView('list', 'comment');"><i
                                    class="fa-solid fa-bars"></i></div>
                            <div class="view_button tiles" onclick="changeView('tile', 'comment');"><i
                            ...
                            <div class="buttons">
                                @foreach ($users as $user)
                                    <div class="checkbox" onclick="selectUser(event, {{ $user->id }})"
                                        ...
                                        <div class="check">
                                            <i
                                                class="{{ isset($selected_users) && in_array($user->toArray(), $selected_users) ? 'fa-solid fa-square-check' : 'fa-regular fa-square' }}"></i>
                                        </div>
